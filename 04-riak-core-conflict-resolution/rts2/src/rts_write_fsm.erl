...
%% client: The external entity that wrote the log entry that produced this stat.
...
execute(timeout, SD0=#state{req_id=ReqID, stat_name=StatName, op=Op, val=Val, preflist=Preflist}) ->
  case Val of
    undefined ->
